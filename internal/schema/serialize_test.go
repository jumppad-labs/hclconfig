...
func TestSerializeInt(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyInt{}, maxDepth)
...
func TestSerializeIntSlice(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyIntSlice{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeIntMap(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyIntMap{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeIntPtr(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyIntPtr{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeIntPtrSlice(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyIntPtrSlice{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeIntPtrMap(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyIntMapPtr{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeString(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyString{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeStringSlice(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStringSlice{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeStringPtr(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStringPtr{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeStringPtrSlice(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStringPtrSlice{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeBool(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyBool{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeBoolSlice(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyBoolSlice{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeBoolPtr(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyBoolPtr{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeBoolPtrSlice(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyBoolPtrSlice{}, maxDepth)
	require.NoError(t, err)
...
func TestSerializeStructPtrDepth1(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructPtr{}, 1)
	require.NoError(t, err)
...
func TestSerializeStructPtrDepth2(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructPtr{}, 2)
	require.NoError(t, err)
...
func TestSerializeStructPtrDepth3(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructPtr{}, 3)
	require.NoError(t, err)
...
func TestSerializeStructSliceDepth1(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructSlice{}, 1)
	require.NoError(t, err)
...
func TestSerializeStructSliceDepth2(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructSlice{}, 2)
	require.NoError(t, err)
...
func TestSerializeStructPtrSliceDepth1(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructPtrSlice{}, 1)
	require.NoError(t, err)
...
func TestSerializeStructPtrSliceDepth2(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructPtrSlice{}, 2)
	require.NoError(t, err)
...
func TestSerializeStructMapDepth1(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructMap{}, 1)
	require.NoError(t, err)
...
func TestSerializeStructMapDepth2(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructMap{}, 2)
	require.NoError(t, err)
...
func TestSerializeStructMapPtrDepth1(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructMapPtr{}, 1)
	require.NoError(t, err)
...
func TestSerializeStructMapPtrDepth2(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.MyStructMapPtr{}, 2)
	require.NoError(t, err)

	require.JSONEq(t, fixtures.MyStructMapPtrDepth2JSON, string(b))
}

func TestSerializeEmbedded(t *testing.T) {
	b, err := GenerateSchemaFromInstance(fixtures.Embedded{}, maxDepth)
	require.NoError(t, err)

	require.JSONEq(t, fixtures.EmbeddedJson, string(b))
}
