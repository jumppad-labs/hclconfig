...
func TestGetterCallsGetWithURLEncodedOutputFolder(t *testing.T) {
	...
	_, err := g.Get("github.com/jumppad-labs/xcl?ref=7271da1cd14778d3762304954d7061cc753da204", "/mycache", false)
	require.NoError(t, err)

	require.Len(t, *calls, 1)

	require.Equal(t, "/mycache/github.com_jumppad-labs_xcl_ref=7271da1cd14778d3762304954d7061cc753da204", (*calls)[0].dest)
}
...
func TestGetterFunctionalTest(t *testing.T) {
	...
	g := NewGoGetter()
	download, err := g.Get("github.com/jumppad-labs/xcl?ref=7271da1cd14778d3762304954d7061cc753da204", dest, false)
	require.NoError(t, err)
