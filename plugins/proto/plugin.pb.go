...
type CreateResponse struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Error             string                 `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	MutatedEntityData []byte                 `protobuf:"bytes,2,opt,name=mutated_entity_data,json=mutatedEntityData,proto3" json:"mutated_entity_data,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *CreateResponse) GetMutatedEntityData() []byte {
	if x != nil {
		return x.MutatedEntityData
	}
	return nil
}
...
func (x *ReadRequest) GetEntityType() string {
	if x != nil {
		return x.EntityType
	}
	return ""
...
func (x *ReadRequest) GetEntitySubType() string {
	if x != nil {
		return x.EntitySubType
	}
	return ""
...
func (x *ReadRequest) GetOldEntityData() []byte {
	if x != nil {
...
func (x *ReadRequest) GetNewEntityData() []byte {
	if x != nil {
...
type ReadResponse struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	EntityData []byte                 `protobuf:"bytes,1,opt,name=entity_data,json=entityData,proto3" json:"entity_data,omitempty"`
	Error      string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	// not_found is true when the provider reported that the real resource no
	// longer exists (plugins.ErrNotFound); error identity doesn't survive the wire
...
func (x *ReadResponse) GetEntityData() []byte {
	if x != nil {
		return x.EntityData
	}
	return nil
...
type UpdateResponse struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Error             string                 `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
	UpdatedEntityData []byte                 `protobuf:"bytes,2,opt,name=updated_entity_data,json=updatedEntityData,proto3" json:"updated_entity_data,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *UpdateResponse) GetUpdatedEntityData() []byte {
	if x != nil {
		return x.UpdatedEntityData
	}
	return nil
}
...
const file_plugins_plugin_proto_rawDesc = "" +
	...
	"\x13mutated_entity_data\x18\x02 \x01(\fR\x11mutatedEntityData\"z\n" +
	...
	"\x05error\x18\x01 \x01(\tR\x05error\"\xa6\x01\n" +
	...
	"\x0fnew_entity_data\x18\x04 \x01(\fR\rnewEntityData\"b\n" +
	...
	"\x05error\x18\x01 \x01(\tR\x05error\x12.\n" +
	"\x13updated_entity_data\x18\x02 \x01(\fR\x11updatedEntityData\"\xa9\x01\n" +
	...
	"\x05error\x18\x02 \x01(\tR\x05error2\x9c\x03\n" +
	"\rPluginService\x12;\n" +
	...
	"\aDestroy\x12\x15.proto.DestroyRequest\x1a\x16.proto.DestroyResponse\x12/\n" +
	"\x04Read\x12\x12.proto.ReadRequest\x1a\x13.proto.ReadResponse\x125\n" +
	...
	"\x04Find\x12\x17.proto.StateFindRequest\x1a\x18.proto.StateFindResponseB+Z)github.com/jumppad-labs/xcl/plugins/protob\x06proto3"
...
var file_plugins_plugin_proto_depIdxs = []int32{
	...
	9,  // 5: proto.PluginService.Read:input_type -> proto.ReadRequest
	...
	10, // 18: proto.PluginService.Read:output_type -> proto.ReadResponse
