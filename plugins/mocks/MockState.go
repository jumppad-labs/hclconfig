...
func (_m *MockState) Find(pattern string) ([]any, error) {
...
func (_c *MockState_Find_Call) Return(_a0 []any, _a1 error) *MockState_Find_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockState_Find_Call) RunAndReturn(run func(string) ([]any, error)) *MockState_Find_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: key
func (_m *MockState) Get(key string) (any, error) {
	ret := _m.Called(key)
...
func (_c *MockState_Get_Call) Return(_a0 any, _a1 error) *MockState_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockState_Get_Call) RunAndReturn(run func(string) (any, error)) *MockState_Get_Call {
	_c.Call.Return(run)
	return _c
}
