...
- [ ] **Scope resources per module instance**
...
- [ ] **Pass variables into a module instance**
...
- [ ] **Allow a child resource to override module-level disabled state**
...
- [ ] **Interpolate values across module boundaries**
...
- [ ] **Resolve dependencies correctly regardless of authoring order**
...
- [ ] **Module block is parsed without error**
...
- [ ] **Resources from a module instance appear in state**
...
- [ ] **Multiple instances of the same module produce independent resources**
...
- [ ] **Repeated instantiation does not leak state between instances**
...
- [ ] **Supplied variable value is reflected in the module's resources**
...
- [ ] **Unsupplied variable falls back to the module's default**
...
- [ ] **Disabling a module instance is reflected on its resources**
...
- [ ] **A resource inside a module can independently override disabled state**
...
- [ ] **A value from one module resource can be referenced by another resource in the same module**
...
- [ ] **A module output is retrievable per instance**
...
- [ ] **Parsing succeeds regardless of declaration order**
...
- [ ] **Resources inside a nested module are correctly scoped and retrievable**
